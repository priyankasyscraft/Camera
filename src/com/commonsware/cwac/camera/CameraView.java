...
public class CameraView extends ViewGroup implements AutoFocusCallback,
	...
	public void record() throws Exception {
		...
		try {
			...
			if (CamcorderProfile.hasProfile(CamcorderProfile.QUALITY_CIF)) {
				recorder.setVideoSize(352, 288);// QUALITY_CIF - (352 x 288)
				// resolution
			} else if (CamcorderProfile
					.hasProfile(CamcorderProfile.QUALITY_QVGA)) {
				recorder.setVideoSize(320, 240);// QUALITY_QVGA - (320x240)
				// resolution.
			} else if (CamcorderProfile
					.hasProfile(CamcorderProfile.QUALITY_HIGH)) {
				recorder.setVideoSize(720, 480);// QUALITY_HIGH - (720 x
				// 480) resolution.
			} else {
				recorder.setVideoSize(320, 240);// QUALITY_QVGA - (320x240)
				// resolution.
			...
			recorder.setMaxFileSize(10000000); // Set max file size 10M
	...
	private void setCameraDisplayOrientation() {
		...
		// Log.d("displayOrientation-----setCameraDisplayOrientation----------",
		// "" + displayOrientation);
	...
	private void setCameraPictureOrientation(Camera.Parameters params) {
		...
		// } else
		// Log.d("displayOrientation-----setCameraPictureOrientation----------",
		// "" + displayOrientation);
		// Log.d("degrees-------", "" + degrees);
		// Log.d("getOrientation-------", ""
		...
		if (lastPictureOrientation != outputOrientation) {
			if ((cameraId == 1) && (degrees == 270 || degrees == 90)) {
				...
				&& (lastPictureOrientation == outputOrientation)) {
			// Log.d("degrees---cameraId----", "" + degrees);
			params.setRotation(90);
		}
		// Log.d("outputOrientation-------", "" + outputOrientation);
	}
